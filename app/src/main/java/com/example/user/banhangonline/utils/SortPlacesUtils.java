...
public class SortPlacesUtils implements Comparator<SanPham> {
    LatLng currentLoc;

    public SortPlacesUtils(LatLng current) {
        currentLoc = current;
    }

    @Override
    public int compare(final SanPham place1, final SanPham place2) {
