...
public class PullBackLayout extends FrameLayout {
    ...
    @Nullable
    private static PullBackLayout.Callback callback;
    ...
    private class ViewDragCallback extends android.support.v4.widget.ViewDragHelper.Callback {
        ...
        public void onViewCaptured(View capturedChild, int activePointerId) {
            if (PullBackLayout.callback != null) {
                PullBackLayout.callback.onPullStart();
            }
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            if (PullBackLayout.callback != null) {
                PullBackLayout.callback.onPull((float) top / (float) PullBackLayout.this.getHeight());
            }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (releasedChild.getTop() > slop) {
                if (PullBackLayout.callback != null) {
                    PullBackLayout.callback.onPullComplete();
                }
            } else {
                if (PullBackLayout.callback != null) {
                    PullBackLayout.callback.onPullCancel();
                }
